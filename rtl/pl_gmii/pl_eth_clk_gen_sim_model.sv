...
// critical warnings and the exact expected 125.000/300.000/62.500MHz
...
module pl_eth_clk_gen_sim_model #(
  ...
  output logic clk_o,   // 62.5 MHz -- see pl_eth_clk_gen.sv's header:
  ...
  logic clk_q = 1'b0;
  always #8.000 clk_q = ~clk_q; // 62.5 MHz
  assign clk_o = clk_q;
